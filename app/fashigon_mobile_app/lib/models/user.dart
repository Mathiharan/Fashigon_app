...
class User {
  ...
  // Serialization: Convert a User object to a Map
  ...
  // Purpose - Manipulation and user : Once a data is converted to a User object
  ...
  // and then uses fromMap to converts it into a User object.
