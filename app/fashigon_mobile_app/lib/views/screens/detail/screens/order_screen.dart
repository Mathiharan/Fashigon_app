...
import 'package:fashigon_mobile_app/provider/order_provider.dart';
...
import 'package:fashigon_mobile_app/views/screens/detail/screens/order_detail_screen.dart';
...
class _OrderScreenState extends ConsumerState<OrderScreen> {
  ...
  Future<void> _deleteOrder(String orderId) async {
    ...
    try {
      ...
      await _fetchOrders(); // Refresh the orders after deletion
    } catch (e) {
