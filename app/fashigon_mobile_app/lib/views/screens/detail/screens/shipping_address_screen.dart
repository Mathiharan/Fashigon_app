  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Padding(
        ...
        child: InkWell(
          onTap: () async {
            // Add your onTap logic here, e.g., form validation or navigation
            if (_formKey.currentState!.validate()) {
              ...
              await _authController
                  ...
                  .whenComplete(() {
                    ...
                    Navigator.pop(
                      context,
                    ); // this will close the shipping screen meaning it will take us back to the formal whch is the checkout
                  });
            } else {
              print('Not Valid');
            }
