...
import 'package:fashigon_mobile_app/views/screens/detail/screens/order_screen.dart';
import 'package:fashigon_mobile_app/views/screens/detail/screens/shipping_address_screen.dart';
import 'package:fashigon_mobile_app/controllers/auth_controller.dart';
...
class _AccountScreenState extends ConsumerState<AccountScreen> {
  ...
  void initState() {
    super.initState();
    // Fetch the delivered order count only once when the widget is initialized.
  ...
  Widget build(BuildContext context) {
    // watch the deliveredOrderCountProvider to get the latest count
